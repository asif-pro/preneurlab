    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                </div><center><h3 style="color: red"><?php

if (isset($_REQUEST['msg'])){
    if($_REQUEST['msg'] == 'emptF'){
        echo "No field should remain empty";
    }
    elseif($_REQUEST['msg'] == 'nimg'){
        echo "You must select an image File";
    }
                ...
                <div class="card-body">
                    <form method="POST" action="../php/registration.php" enctype="multipart/form-data">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="userID" value="<?= $wid?>" readonly>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="password" value="<?=$str?>" readonly>
                        ...
                        <div>
                            ...
                            <button class="btn btn--radius-2 btn--blue" type="submit" name="rbtn">Register</button>
                        </div><center><h3 style="color: red"><?php

if (isset($_REQUEST['msg'])){
    if($_REQUEST['msg'] == 'emptF'){
        echo "One or more field remained empty";
    }
    elseif($_REQUEST['msg'] == 'nimg'){
        echo "You must select an image File";
    }
