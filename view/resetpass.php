                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Reset Password</span></li>
                            </ol>
                        </nav>
                ...
                <div class="container">
                    ...
                    <div class="row">
						...
						if (isset($_REQUEST['msg'])){
							if($_REQUEST['msg'] == 'opdm'){
								echo "Password Changed Successfully !";
							}elseif ($_REQUEST['msg'] == 'ddm') {
								echo "New Pass word & Confirm new Password didn't matched";
							}
							elseif ($_REQUEST['msg'] == 'wp') {
                                ...
                                <div class="widget-content widget-content-area">
                                    <form method="POST" action="../php/resetpass.php">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Confirm New Password " name="cnpass">
                                        </div>
                                        
                                       
                                        <button type="submit" class="btn btn-primary mt-3" name="rst">Reset</button>
                                    </form>
