<?php 
    ...
    //session_start();
    // $accountID=$_GET['link'];
    // $accountList = getTheAccount($accountID);
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Salary</span></li>
                            </ol>
                        </nav>
...
if (isset($_REQUEST['msg'])){
    if($_REQUEST['msg'] == 'blnk'){
        echo "Account Name shouldn't be blank";
    }
                                    ...
                                    <div class="input-group mb-4">
                                      ...
                                      <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)"  name="acname">
                                    </div>
                                    ...
                                    <div class="input-group mb-4">
                                      ...
                                      <input type="number" name="acincome" step="0.01"class="form-control" aria-label="Amount (to the nearest dollar)" >
                                    </div>

                                    <p class="">Expense</p>
                                    <div class="input-group mb-4">
                                      <input type="number" name="acexpense" step="0.01" class="form-control" aria-label="Amount (to the nearest dollar)"  values="">
                                      <div class="input-group-append">
                                        <span class="input-group-text">-</span>
                                        <span class="input-group-text">$</span>
                                      </div>
                                    </div>
                                    <input type="hidden" name="acid" values="">

                                    <div class="">
                              
                                    <button type="submit" name="abtn" class="btn btn-primary mb-2 mr-2 btn-rounded"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>Add Account </button>
                                   
                                    <a href="accounts.php" class="btn btn-dark mb-2 mr-2 rounded-circle"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></a>
